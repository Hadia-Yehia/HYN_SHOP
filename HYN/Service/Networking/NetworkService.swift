...
class NetworkService:NetworkServiceProtocol{
    ...
    //MARK: Cart logic
//    func getAllItemsAddedToCart(draftOderId:Int,completionHandler: @escaping (Result<CustomerAddresses, NetworkError>)
//    {
//        let url = "https://mad34-alex-ios-team2.myshopify.com/admin/api/2023-04/draft_orders/\(draftOderId).json"
//
//        AF.request(url,headers: NetworkConstants.shared.accessToken)
//            .response{response in
//                switch response.result{
